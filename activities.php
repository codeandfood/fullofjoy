...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- CONTENT -->
        <!-- Intro Section -->
        <section class="inner-intro bg-image overlay-light parallax parallax-background1" data-background-img="img/full/13.jpg">
            <div class="container">
                <div class="row title">
            ...
            <div class="container">
                ...
                <div class="row container-masonry nf-col-2">
                    ...
                    <div class="nf-item branding coffee spacing">
                        <div class="item-box">
                            <a href="portfolio-single1.html">
                                <img alt="1" src="img/activities/angling.jpg" class="item-container">
                                <div class="item-mask">
                    ...
                    <div class="nf-item photo spacing">
                        <div class="item-box">
                            <a href="portfolio-single2.html">
                                <img alt="1" src="img/activities/Backwater sailing.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item branding photo spacing">
                        <div class="item-box">
                            <a href="portfolio-single3.html">
                                <img alt="1" src="img/activities/boat ride.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item design spacing">
                        <div class="item-box">
                            <a href="portfolio-single4.html">
                                <img alt="1" src="img/activities/camping.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item photo spacing">
                        <div class="item-box">
                            <a href="portfolio-single1.html">
                                <img alt="1" src="img/activities/canoe ride.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item photo spacing">
                        <div class="item-box">
                            <a href="portfolio-single5-slider.html">
                                <img alt="1" src="img/activities/cultural trail.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item design spacing">
                        <div class="item-box">
                            <a href="portfolio-single6-video.html">
                                <img alt="1" src="img/activities/cycling.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item coffee spacing">
                        <div class="item-box">
                            <a href="portfolio-single7-youtube.html">
                                <img alt="1" src="img/activities/Elephant ride.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item design spacing">
                        <div class="item-box">
                            <a href="portfolio-single8-vimeo.html">
                                <img alt="1" src="img/activities/nature walks.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item design spacing">
                        <div class="item-box">
                            <a href="portfolio-single1.html">
                                <img alt="1" src="img/activities/plantation walks.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item photo spacing">
                        <div class="item-box">
                            <a href="portfolio-single2.html">
                                <img alt="1" src="img/activities/river kayak.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item photo spacing">
                        <div class="item-box">
                            <a href="portfolio-single4.html">
                                <img alt="1" src="img/activities/trekking.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
                    ...
                    <div class="nf-item branding coffee spacing">
                        <div class="item-box">
                            <a href="portfolio-single5-slider.html">
                                <img alt="1" src="img/activities/village trail.jpg" class="item-container">
                                <div class="item-mask">
                                    <div class="item-caption">
